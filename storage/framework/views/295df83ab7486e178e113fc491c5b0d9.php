...
<main class="min-h-screen bg-white">
    <div class="relative min-h-[60vh] flex items-center bg-[#003366] overflow-hidden pt-20">
        <div class="absolute inset-0">
            <img src="<?php echo e(asset('images/Prima.png')); ?>" class="w-full h-full object-cover opacity-30 scale-105">
    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
        <div class="flex flex-wrap gap-3 justify-center md:justify-start">
            <?php $__currentLoopData = ['Golden Fiesta', 'Fiesta', 'Champ', 'Okey', 'Akumo', 'Asimo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $__currentLoopData = range(1, 10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="group relative bg-white rounded-[2rem] p-4 shadow-md hover:shadow-2xl transition-all duration-500 border border-slate-50 overflow-hidden flex flex-col h-full">
                    ...
                    <div class="relative aspect-square mb-4 overflow-hidden rounded-2xl bg-slate-50">
                        <img src="<?php echo e(asset('images/' . $fileName)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\OneMoreLightLP\resources\views/public/content/MakananOlahan.blade.php ENDPATH**/ ?>